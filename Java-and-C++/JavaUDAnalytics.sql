...
\set libfile '\''`pwd`'/build/JavaUDAnLib.jar\''
CREATE LIBRARY AnalyticFunctions AS :libfile LANGUAGE 'JAVA';

-- Step 2: Create Functions
CREATE ANALYTIC FUNCTION an_rank AS LANGUAGE 'Java'
NAME 'com.vertica.JavaLibs.RankFactory' LIBRARY AnalyticFunctions;

CREATE ANALYTIC FUNCTION an_lag AS LANGUAGE 'java'
NAME 'com.vertica.JavaLibs.LagFactory' LIBRARY AnalyticFunctions;

CREATE ANALYTIC FUNCTION an_lead AS LANGUAGE 'java'
NAME 'com.vertica.JavaLibs.LeadFactory' LIBRARY AnalyticFunctions;
